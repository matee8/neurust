...
impl<B: Backend> TensorBase<B> {
    ...
    impl_axis_op!(
        /// Finds the minimum elements of the tensor along the specified axis,
        /// removing that dimension.
        ///
        /// # Errors
        ///
...
mod tests {
    ...
    mod ops {
        ...
        test_axis_op!(min, checked_min, min_keep_dims, checked_min_keep_dims);
